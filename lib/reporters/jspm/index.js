 ...
 */
function getJspmCreditsPerCategory( projectPath, category ) {
  var credits = [];
...
* @return {Array}              list of credits
*/
function getJspmCredits( projectPath ) {
  var credits    = [];
  var categories = [ 'npm', 'github/components' ];

  categories.forEach( function( category ) {
    credits = credits.concat( getJspmCreditsPerCategory( projectPath, category ) );
  } );

  return credits;
}

module.exports = getJspmCredits;
