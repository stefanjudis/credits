...
test( 'getCredits - get availalbe npm credits', t => {
  ...
  fs.copySync( `${fixtures}/_node_modules/bar/_node_modules`, `${fixtures}/node_modules/bar/node_modules` );
  fs.copySync( `${fixtures}/_node_modules/baz/_node_modules`, `${fixtures}/node_modules/baz/node_modules` );
  fs.copySync( `${fixtures}/_node_modules/cycle/_node_modules`, `${fixtures}/node_modules/cycle/node_modules` );
